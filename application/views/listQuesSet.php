...
<aside class="right-side">
    ...
    <aside>
                        ...
                        <tbody aria-relevant="all" aria-live="polite" role="alert">                                                    
                            ...
                            if ($c > 0) {
                                while ($i < $c) {
                                    ?>
                                    <tr class="even">                                                                                            
                                        <td class="hide"><?php echo $a[$i]->quesSetId; ?></td>
                                        <td class="text-center"><?php echo $i + 1; ?></td> 
                                        <td class="text-center"><?php echo $a[$i]->chapter_name; ?></td>
                                        <td class="text-center"><?php echo $a[$i]->quesSetType; ?></td>
                                        <td class="text-center"><?php echo $a[$i]->quesSetName; ?></td>
                                        <td class="hide"><?php echo $a[$i]->question_file; ?></td>
                                        <td class="hide"><?php echo $a[$i]->answer_file; ?></td>
                                        <td class="text-center">
                                            <a href="#" onclick="viewQuesPdf(this)" class="btn btn-primary">View</a>
                                        </td>
                                        <td class="text-center">
                                            <a href="#" onclick="viewAnsPdf(this)" class="btn btn-primary">View</a>
                                        </td>
                                    </tr>
                                    <tr class="even">
                                    </tr>
        ...
        <script>
            function viewQuesPdf(obj)
            {
                var adminPdfPath = '<?php echo $this->config->item('adminPath'); ?>';
                adminPdfPath = adminPdfPath+"pdf/";
                var question_data = [];
                ...
                console.log(question_data[4]);
                console.log(question_data[5]);
                console.log(adminPdfPath);

                var path = adminPdfPath+question_data[4];
            ...
            function viewAnsPdf(obj)
            {
                ...
                var path = adminPdfPath+question_data[5];
